...
\begin{document}
		\section{Architettura dell'applicazione}
			...
			\subsection{Architettura client}
				...
				\gl{HTML5}, \gl{CSS} e Javascript.\\
				La sua architettura è costruita utilizzando il \gl{framework} Backbone.js che offre
			...
			\subsection{Architettura server}
				Il server (parte \gl{back-end}) è sviluppato in \gl{Node.js} ed offre i seguenti servizi:
				\begin{itemize}
