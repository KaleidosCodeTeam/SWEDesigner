...
\begin{document}
		\section{Specifica delle componenti}
			...
			\subsection{SWEDesigner::Client::Model}
				...
				\subsubsection{Client::Model::DataManager}
				...
				\subsubsection{Client::Model::ProjectModel}
				...
				\subsubsection{Client::Model::ToolbarModel}
				...
				\subsubsection{Client::Model::Project}
				...
				\subsubsection{Client::Model::RequestHandler}
			...
			\subsubsection{Client::Model::Items::Swedesigner}
			...
			\subsection{SWEDesigner::Client::View}
				...
				\subsubsection{Client::View::ProjectView}
				...
				\subsubsection{Client::View::TitlebarView}
				...
				\subsubsection{Client::View::ToolbarView}
				...
				\subsubsection{Client::View::PathView}
				...
				\subsubsection{Client::View::EditPanelView}
			...
			\subsubsection{Server::CodeGenerator::CodeGenerator}
			...
			\subsubsection{Server::CodeGenerator::Parser::Parser}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedProgram}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedPackage}
			...
			\end{itemize}	
				...
				\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedClass}
			...
			\end{itemize}		
				...
				\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedAttribute}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedOperation}
			...
			\end{itemize}
				...
				\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedParameter}
		...
		\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedActivity}
		...
		\end{itemize}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubble}
		...
		\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleIf}
		...
		\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleStart}
		...
		\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleElse}
		...
		\end{itemize}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleFor}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleWhile}
			...
			\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleCustom}
			...
			\end{itemize}
				...
				\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleReturn}
			...
			\end{itemize}
				...
				\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleDefinition}
		...
		\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleAssignment}
		...
		\subsubsection{Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleLink}
		...
		\end{itemize}
			...
			\subsubsection{Server::CodeGenerator::Coder::JavaCoder}
			...
			\subsubsection{Server::CodeGenerator::Coder::JavascriptCoder}
			...
			%		\subsubsection{Server::CodeGenerator::Coder::CoderClass}
			...
			\subsubsection{Server::CodeGenerator::Coder::CoderOperation}
			...
			\subsubsection{Server::CodeGenerator::Coder::CoderParameter}
			...
			\subsubsection{Server::CodeGenerator::Coder::CoderAttribute}
			...
			\subsubsection{Server::CodeGenerator::Coder::CoderActivity}
			...
			\subsubsection{Server::CodeGenerator::Coder::Class}
			...
			\subsubsection{Server::CodeGenerator::Coder::CodedProg}
			...
			%		\subsubsection{Server::CodeGenerator::Coder::CoderElement}
			...
			\subsubsection{Server::CodeGenerator::Builder::Builder}
			...
			\subsubsection{Server::CodeGenerator::Zipper::Zipper}
			\hypertarget{SWEDesigner::Server::CodeGenerator::Builder::Builder}{}
			\begin{itemize}
				\item \textbf{Tipo}: \emph{Class};
			...
			Questo package non contiene dei sottopackage.\\
			Le classi contenute al suo interno verranno elencate qui di seguito.
			\subsubsection{Server::DataManager::DataManager}
