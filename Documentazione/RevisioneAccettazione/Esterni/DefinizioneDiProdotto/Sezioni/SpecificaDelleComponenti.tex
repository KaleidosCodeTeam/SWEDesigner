...
\begin{document}
		\section{Specifica delle componenti}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedProgram}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedPackage}
			...
			\end{itemize}	
				...
				\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedClass}
			...
			\end{itemize}		
				...
				\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedAttribute}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedOperation}
			...
			\end{itemize}
				...
				\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedParameter}
		...
		\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedActivity}
		...
		\end{itemize}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubble}
		...
		\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleIf}
		...
		\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleStart}
		...
		\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleElse}
		...
		\end{itemize}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleFor}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleWhile}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleCustom}
			...
			\end{itemize}
				...
				\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleReturn}
			...
			\end{itemize}
				...
				\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleDefinition}
		...
		\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleAssignment}
		...
		\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::ParsedElements::ParsedBubbleLink}
		...
		\end{itemize}
			...
			\subsubsection{SWEDesigner::Server::CodeGenerator::Coder::Class}
