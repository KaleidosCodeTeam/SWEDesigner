...
\begin{longtabu} to \textwidth {
	...
	\toprule
		...
		2.0.1 & 22/05/2017 & Pezzuto Francesco & Preso atto degli errori segnalati nella valutazione di RP; sistemate/ampliate sezioni: \ref{sez:obiettiviQualitaProcesso}, \ref{sez:obiettiviQualitaProdotto},  \ref{sez:MisureEMetriche}, \ref{sez:resocontoAttivitaVerifica}\\
		\addlinespace[0.2em]
		\midrule
		\addlinespace[0.2em]
