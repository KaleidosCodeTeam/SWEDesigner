...
\begin{document}
	\begin{titlepage}
		...
		\vspace{1cm}
		{\scshape\Large Verbale dell'incontro interno del gruppo \kaleidoscode\ in data 30/07/2017 \\}		% cambiare il titolo per ogni documento
		\vspace{1.4cm}
		\logo
		\vspace{1.2cm}
		...
		\begin{tabular}{r|l}
			{\hfill \textbf{Data Redazione}} 	& 31/07/2017\\	% cambiare la data per ogni documento
