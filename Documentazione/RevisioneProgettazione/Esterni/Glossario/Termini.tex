...
\newglossaryentry{JointJS} {
	name=JointJS,
	description={JointJS è una libreria Javascript per diagrammi. Può essere usata per la creazione
	di diagrammi statici e di strumenti per il disegno di diagrammi interattivi}
}
\newglossaryentry{JSON} {
	name=JSON,
	description={Acronimo di JavaScript Object Notation (Notazione di Oggetti JavaScript), è un
	formato adatto per lo scambio di dati in applicazioni client-server}
}
