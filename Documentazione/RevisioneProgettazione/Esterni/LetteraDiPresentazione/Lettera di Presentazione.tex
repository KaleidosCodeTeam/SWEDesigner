...
\begin{document}
	\begin{titlepage}
		...
		\begin{itemize}
			\item \analisideirequisitiv\ (Esterni/AnalisiDeiRequisiti\char`_v2.0.0.pdf);
			\item \glossariov\ (Esterni/Glossario\char`_v2.0.0.pdf);
			\item \normediprogettov\ (Interni/NormeDiProgetto\char`_v2.0.0.pdf);
			\item \pianodiprogettov\ (Esterni/PianoDiProgetto\char`_v2.0.0.pdf);
			\item \pianodiqualificav\ (Esterni/PianoDiQualifica\char`_v2.0.0.pdf);
			\item \studiodifattibilitav\ (Interni/StudioDiFattibilita\char`_v2.0.0.pdf);
			\item \specificatecnicav (Esterni/SpecificaTecnica\char`_v1.0.0.pdf);			
		...
		%non mi convince al 100%, eventualmente da modificare%
