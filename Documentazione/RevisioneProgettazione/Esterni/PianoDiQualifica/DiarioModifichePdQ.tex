...
\begin{longtabu} to \textwidth {
	...
	\toprule
		...
		\midrule
		\addlinespace[0.2em]
		1.1.0 & 01/04/2017 & Bonato Enrico & Verifica del documento\\
		\addlinespace[0.2em]
		\midrule
		\addlinespace[0.2em]
		1.0.7 & 30/04/2017 & Sanna Giovanni & Test di validazione rivisti e approfonditi; inserito tracciamento test di validazione-Requisiti \\
		\addlinespace[0.2em]
		\midrule
		\addlinespace[0.2em]
		1.0.6 & 30/04/2017 & Sovilla Matteo & Stesura test di integrazione\\
		\addlinespace[0.2em]
		\midrule
		\addlinespace[0.2em]
		1.0.5 & 30/04/2017 & Bonolo Marco & Stesura test di sistema\\
		\addlinespace[0.2em]
		\midrule
		\addlinespace[0.2em]
