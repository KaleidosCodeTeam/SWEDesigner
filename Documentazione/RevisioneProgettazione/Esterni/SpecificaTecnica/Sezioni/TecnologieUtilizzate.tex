	...
	\section{Tecnologie utilizzate}
		\subsection{HTML5}
			...
			\paragraph{Principali svantaggi}
				\begin{itemize}
					\item Linguaggio non ancora	pienamente supportato da tutti i browser.
				\end{itemize}
		\subsection{CSS}
			Linguaggio per la formattazione e presentazione delle pagine HTML, come richiesto dal
			Proponente.
			\paragraph{Principali vantaggi}
			\begin{itemize}
					...
					a screen-reader, browser testuali e dispositivi alternativi.
				\end{itemize}
			\paragraph{Principali svantaggi}
				\begin{itemize}
		...
		\subsection{Javascript}
			...
			\begin{itemize}
					...
					\item Rende possibile interagire con il DOM.
				\end{itemize}
			\paragraph{Principali svantaggi}
				\begin{itemize}
		...
		\subsection{Backbone.js}
			Framework Javascript utilizzato da JointJS utile per fornire una struttura ad applicazioni
			web rendendo disponibili modelli con binding chiave-valore ed eventi personalizzati,
			collezioni con una API contenente funzioni enumerabili, viste con gestione degli eventi
			...
			\begin{itemize}
					...
					\item Supporta plugins di terze parti.
				\end{itemize}
			\paragraph{Principali svantaggi}
				\begin{itemize}
					\item Non supporta il data binding bidirezionale;
					\item È difficile eseguire test di unità sulle views scrivendo poco codice mock.
				\end{itemize}
		\subsection{Node.js}
			...
			ad eventi asincroni ed è costruito sul motore Javascript v8; non è multi-threaded, ma
			...
			\begin{itemize}
					...
					\item Community molto attiva con molto codice condiviso via GitHub, ecc.
				\end{itemize}
			\paragraph{Principali svantaggi}
				\begin{itemize}
					\item Rende complessa la gestione di database relazionali.
				\end{itemize}
		\subsection{JSON}
			...
			alternativa a XML. JSON è basato su due strutture:
			\begin{itemize}
		...
		\subsection{AJAX}
			...
			\paragraph{Principali svantaggi}
				\begin{itemize}
					\item Può rendere difficile il debug della pagina web sulla quale è utilizzato
...
%				\end{itemize}
		\subsection{MySQL}
			...
			\begin{itemize}
					...
					\item È progettato con in mente il web, il cloud e big data;
