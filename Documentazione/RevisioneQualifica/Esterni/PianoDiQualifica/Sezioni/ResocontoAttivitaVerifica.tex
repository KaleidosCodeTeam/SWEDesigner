			...
			\subsection{Periodo di Progettazione di dettaglio e Codifica}
				...
				\subsubsection{Progettazione}
					...
					\begin{tabular}{|>{\centering}p{6cm}|c|c|c|c|}
						\hline
						\rowcolor{blue!30}\textbf{Metrica} & \textbf{Accettazione} &\textbf{04/07/2017}&\textbf{Esito} \\ \hline
						Numero di violazioni delle norme di progettazione & 0-10 &  5 & Ottimale\\ \hline
					\end{tabular}
