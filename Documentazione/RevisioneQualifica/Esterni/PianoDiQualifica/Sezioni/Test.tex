...
\newpage
	...
	\begin{longtable}{|c|>{\centering}p{8cm}|l|l|}
		...
		\hline
		\hypertarget{TI1.1.1}{TI1.1.1} &Viene verificato che il sistema gestisca correttamente le componenti della View in particolare l'integrazione tra la TitleBarView, la ToolBarView, l'AddressView, l'EditPanelView e il Paper.
		& Non implementato.
		...
		\hline
		\hypertarget{TI1.1.3}{TI1.1.3} &Viene verificata l'integrazione per le componenti del Model, in particolare Command, Dao, RequestHendler, Main Model e State.
		& Non implementato.
		...
		\hline
		\hypertarget{TI1.1.3.1}{TI1.1.3.1} &Viene verificato che il modulo Command gestisca correttamente i vari comandi impartiti dai moduli della View ai rispettivi moduli del Model.
		& Non implementato.
		& SweDesigner::Client::Model::Command.
		
		% Dao 1.1.2.2
		\\%Test TI1.1.3.2}
		
		\hline
		\hypertarget{TI1.1.3.2} {TI1.1.3.2} &Viene verificato che il DAO all'interno del Model carichi correttamente un progetto.
		& DAO.
		& Superato.
		...
		\hline
		\hypertarget{TI1.1.3.3}{TI1.1.3.3}& Viene verificato che il DAO all'interno del Model salvi correttamente un progetto.
		&DAO.
		& Superato.
		...
		\hline
		\hypertarget{TI1.1.3.4}{TI1.1.3.4}& Viene verificata l'integrazione per le componenti del RequestHandler del Client, in particolare Sender e Receiver.
		& RequestHandler.
		& Superato.
		% Sender 1.1.2.3.1
		\\%Test TI1.1.3.4.1}
		...
		\hline
		\hypertarget{TI1.1.3.4.1}{TI1.1.3.4.1}& Viene verificato che il Sender all'interno del Client invii le richieste per bubble correttamente al Server.
		& Sender.
		& Superato.
		...
		\hline
		\hypertarget{TI1.1.3.4.2}{TI1.1.3.4.2}& Viene verificato che il Sender all'interno del Client invii  correttamente al Server le richieste per la creazione di codice a partire dal file \gl{JSON}.
		& Sender.
		& Superato.
		...
		\hline
		\hypertarget{TI1.1.3.5}{TI1.1.3.5}& Viene verificato che il Receiver all'interno del Client riceva correttamente le bubble dal Server.
		& Receiver.
		& Superato.
		...
		\hline
		\hypertarget{TI1.1.3.6}{TI1.1.3.6}& Viene verificata l'integrazione per il MainModel all'interno del Client con i vari moduli del Model collegati ai moduli della View, in particolare con il DiagramTree, la TitleBarModel, la ToolBarModel, l'AddressModel e l'EditPanelModel. 
		& MainModel.
		& Superato.
		...
		\hline
		\hypertarget{TI1.1.3.7}{TI1.1.3.7}& Viene verificata l'integrazione per il modulo Diagram all'interno del Client con il framework JointJS. 
		& Diagram.
		& Superato.
	...
	\hline
		\hypertarget{TI1.1.3.8}{TI1.1.3.8}& Viene verificato che lo State del Client memorizzi correttamente la sequenza dei vari Command. 
		& State.
		& Superato.
		...
		\hline
		\hypertarget{TI1.2.1}{TI1.2.1}& Viene verificata l'integrazione per le componenti del RequestHandler del Server.
		& RequestHandler.
		& Superato.
		...
		\hline
		\hypertarget{TI1.2.1.2}{TI1.2.1.2}& Viene verificato che il Sender all'interno del Server invii correttamente al Client il file .zip contenente il codice generato.
		& RequestHandler.
		& Non implementato.
