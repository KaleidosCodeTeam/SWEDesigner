...
%%%%%%%%%%%%%%%%%%% SEZIONE PACKAGE %%%%%%%%%%%%%%%%%%%
		\paragraph{Caso d'uso UC : Editare il diagramma dei package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
				...
				attraverso l'editor.
			\end{itemize}
		\paragraph{Caso d'uso UC : Creare un package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
			...
			\end{itemize}
		\paragraph{Caso d'uso UC : Modificare un package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
				...
				al package.
			\end{itemize}
		\paragraph{Caso d'uso UC : Definire il nome del package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
				...
				al package.
			\end{itemize}
		\paragraph{Caso d'uso UC : Impostare la visibilità del package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
				\item \textbf{Descrizione}: L'utente può impostare la visibilità
				del package;
				...
				del package.
			\end{itemize}
		\paragraph{Caso d'uso UC : Definire dipendenza tra package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
			...
			\end{itemize}
		\paragraph{Caso d'uso UC : Selezionare un package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
				...
				dall'utente.
			\end{itemize}
		\paragraph{Caso d'uso UC : Rimuovere dipendenza tra package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
			...
			\end{itemize}
		\paragraph{Caso d'uso UC : Innestare una classe nel package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
			...
			\end{itemize}
		\paragraph{Caso d'uso UC : Rimuovere una classe dal package}
			\begin{itemize}
				\item \textbf{Attori}: Utente;
