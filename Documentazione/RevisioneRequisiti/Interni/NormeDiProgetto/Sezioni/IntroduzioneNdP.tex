...
\begin{document}
	\section{Introduzione}
		...
		\subsection{Scopo del prodotto}
			...
			costruzione di diagrammi UML con la relativa generazione
			di codice Java e Javascript utilizzando tecnologie
			web.
		...
		\subsection{Riferimenti utili}
			\subsubsection{Riferimenti normativi}
    			\begin{itemize}
    				\item \textbf{ISO 12207}:\\
    				\url{https://en.wikipedia.org/wiki/ISO/IEC_12207} (03/03/2017);
    				\item \textbf{Swebok v3}: \url{https://www.computer.org/web/swebok/v3} (03/03/2017).
				\end{itemize}
