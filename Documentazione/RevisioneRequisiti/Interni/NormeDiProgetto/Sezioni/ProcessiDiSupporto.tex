	...
	\section{Processi di supporto}
		\subsection{Documentazione}
			...
			\subsubsection{Stesura dei documenti}
				...
				\paragraph{Norme di codifica \LaTeX \\}
					...
					adottare per la stesura dei file di documentazione è quella di indentare il contenuto
					con una tabulazione ogni qualvolta si scrive un nuovo elemento di testo: sezione,
			...
			\subsubsection{Norme tipografiche}
				...
				\paragraph{Punteggiatura}
					\begin{itemize}
						...
						per le parole Proponente e Committente.\\
			...
			\subsubsection{Componenti grafiche}
				...
				\paragraph{Immagini\\}
					Le immagini devono essere convertite in pdf prima di essere incorporate nei
		...
		\subsection{Validazione}
			...
			\subsubsection{Attività}
				...
				Nel caso se ne identifichino, si deve segnalare le criticità ai
		...
		\subsection{Strumento di coordinamento}
			...
			\responsabilediprogetto, il	quale provvederà ad assegnarne lo svolgimento ad uno o più membri
			del gruppo. Il \responsabilediprogetto\ provvederà anche ad assegnare almeno un \verificatore\ in
			ogni attività che avrà il compito di svolgere il task di verifica rispettivamente dedicato
			(solamente al termine di quelli di "produzione").
			...
			Su ogni task il \responsabilediprogetto\ deve inserire il tempo previsto per completarlo e al
		...
		\subsection{Altri strumenti}
			...
			\subsubsection{\LaTeX}
				...
				formattazione, permettendo un versionamento più semplice e consentendo di definire templates
			...
			\subsubsection{Strumenti per il controllo ortografico}
				...
				viene usato il controllo ortografico LanguageTool versione 3.6, integrabile
			...
			\subsubsection{Strumenti per la validazione W3C}
				...
				\begin{itemize}
					\item \url{https://validator.w3.org/} per le pagine web;
					\item \url{https://jigsaw.w3.org/css-validator/} per i fogli di stile.
				\end{itemize}
