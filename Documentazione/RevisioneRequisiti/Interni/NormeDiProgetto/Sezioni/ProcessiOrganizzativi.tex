	...
	\section{Processi organizzativi}
		...
		\subsection{Strumenti di coordinamento}
			...
			\begin{itemize}
				...
				\item \textbf{Trello:} ci è sembrato inadeguato alle esigenze del gruppo perché troppo semplice; %forma? 
		...
		\subsection{Altri strumenti}
			\subsubsection{Google Drive}
				...
				\end{itemize}
				La possibilità di installare Drive\ped{G} sul proprio PC dà a ogni componente del gruppo la possibilità di avere a disposizione documentazione e software anche offline. Google Drive\ped{G} viene utilizzato come strumento di supporto allo sviluppo della documentazione e del software presente su Git\ped{G}.
			\subsubsection{ProjectLibre}
				...
				ProjectLibre è un programma open source per il project management. É basato su Java\ped{G} ed è quindi eseguibile su ogni sistema operativo. É il successore ufficiale di OpenProj. Tale software è stato scelto in quanto possiede tali caratteristiche:
				\begin{itemize}
					\item Portabilità, essendo basto su Java\ped{G};
					\item Open-source;
					\item Genera grafici Gantt\ped{G};
					\item Genera automaticamente grafici Program Evaluation and Review Technique (PERT\ped{G}) a partire dal Gantt\ped{G};
					...
					\item Salvataggio su file XML\ped{G}: essendo un file testuale è possibile fare il merge dei file in caso di conflitti su repository\ped{G}. 
				\end{itemize}
			\subsubsection{\LaTeX}
