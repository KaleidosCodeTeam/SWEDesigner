...
\begin{document}
	\section{Introduzione}
		\subsection{Scopo del documento}
			L'obiettivo del documento è quello di esprimere le motivazioni che hanno portato il gruppo a scegliere il \gl{capitolato} C6 - SWEDesigner: editor di diagrammi \gl{UML} con generazione di codice Platform.
