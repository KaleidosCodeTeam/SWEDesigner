...
\begin{document}
	\section{Capitolato C1}
		...
		Il \gl{capitolato} richiede lo sviluppo di un API marchet che consiste in un sito web dove gli utente possono condividere e monitorare l'uso di \gl{microservizi} che hanno creato.
		...
		\begin{itemize}
			\item I \gl{microservizi} che si vogliono condividere devono essere scritti in \gl{Jolie};
