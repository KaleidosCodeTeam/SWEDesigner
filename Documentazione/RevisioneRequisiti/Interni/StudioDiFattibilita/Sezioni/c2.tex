...
\begin{document}
	\section{Capitolato C2}
		...
		\begin{itemize}
			...
			\item \textbf{Node.Js} \textbf{\gl{Swift}} come linguaggio di programmazione lato server;
