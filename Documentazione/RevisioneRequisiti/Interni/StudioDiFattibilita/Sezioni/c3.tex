...
\begin{document}
	\section{Capitolato C3}
		...
		\subsection{Dominio tecnologico} %posso usare proponente cosi??
			Il \textit{proponente} non richiede uno \gl{stack} tecnologico particolare. Suggerisce però le seguenti teconologie:
			\begin{itemize}
		...
		\subsection{Valutazione}
			\subsubsection{Aspetti positivi}
				...
				\begin{itemize}
					\item lo \gl{stack} tecnologico consigliato dal \textit{proponente} sembra ragionevolmente semplice da utilizzare;
			...
			Il progetto sembra interessante per lo \gl{stack} tecnologico consigliato e per la tematica affrontata. Il fatto che il \textit{proponente} si trova all'estero, però, è un fattore di rischio molto alto in quanto il gruppo teme che la comunicazione possa essere difficile e frammentaria. Per questo motivo il \gl{progetto} è stato scartato.
\end{document}