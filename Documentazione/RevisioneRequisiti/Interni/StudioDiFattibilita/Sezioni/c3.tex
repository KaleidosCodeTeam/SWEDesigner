...
\begin{document}
	\section{Capitolato C3}
		...
		\subsection{Valutazione}
			...
			Il progetto sembra interessante per lo stack tecnologico consigliato e per la tematica affrontata. Il fatto che il proponente si trova all'estero, però, è un fattore di rischio molto alto in quanto il gruppo teme che la comunicazione possa essere difficile e frammentaria. Per questo motivo il gruppo \kaleidoscode\ ha preferito scartare questo \gl{capitolato}.
\end{document}