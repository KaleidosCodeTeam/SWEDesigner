...
\begin{document}
	\section{Capitolato C3}
		...
		\subsection{Dominio tecnologico} %posso usare proponente cosi??
			Il proponente non richiede uno \gl{stack tecnologico} particolare. Suggerisce però le seguenti tecnologie:
			\begin{itemize}
		...
		\subsection{Valutazione}
			...
			Il progetto sembra interessante per lo stack tecnologico consigliato e per la tematica affrontata. Il fatto che il referente dell'azienda proponente si trova all'estero, però, è un fattore di rischio molto alto in quanto il gruppo teme che la comunicazione possa essere difficile e frammentaria. Per questo motivo il gruppo \kaleidoscode\ ha preferito scartare questo \gl{capitolato}.
\end{document}
