...
\begin{document}
	\section{Capitolato C4}
		\subsection{Descrizione}
			L'obiettivo di questo \gl{capitolato} è realizzare un'applicazione in ambiente \gl{Android} che agevoli la
			...
			\end{itemize}
			Le tipologie di applicazione da sviluppare proposte sono un lettore di \gl{e-book} oppure un
			...
			testo sorgente tra \gl{e-book}, \gl{pdf}, \gl{HTML}, messaggi o semplice testo.
