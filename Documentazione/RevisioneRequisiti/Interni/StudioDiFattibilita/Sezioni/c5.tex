...
\begin{document}
	\section{Capitolato C5}
		...
		L'obiettivo di questo \gl{capitolato} è quello di creare un \gl{framework} chiamato Monolith che permetterà di creare "interactive bubbles" facilmente (per bubbles sono intese tutte quelle features che possono essere aggiunte a un'applicazione di messaggistica come mini-giochi, sondaggi, ecc...)   
