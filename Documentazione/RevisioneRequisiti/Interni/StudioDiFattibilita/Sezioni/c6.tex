...
\begin{document}
	\section{Capitolato scelto}
		\subsection{Descrizione}
			\kaleidoscode\ ha scelto di presentare una proposta d'appalto per il \gl{capitolato} C6: \progetto.\\
			Lo scopo del progetto è di sviluppare un \gl{editor} di diagrammi \gl{UML} che generi il relativo codice \gl{Java} e
